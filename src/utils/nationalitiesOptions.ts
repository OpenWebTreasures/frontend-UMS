...
export const nationalities: NationalityOption[] = [
    ...
    { 'label': 'Antigua_and_Barbuda', 'value': 'Antigua_and_Barbuda' },
    ...
    { 'label': 'Bosnia_and_Herzegovina', 'value': 'Bosnia_and_Herzegovina' },
    { 'label': 'Botswanan', 'value': 'Botswanan' },
    { 'label': 'Brazilian', 'value': 'Brazilian' },
    { 'label': 'British', 'value': 'British' },
    { 'label': 'British_Virgin_Islander', 'value': 'British_Virgin_Islander' },
    ...
    { 'label': 'Cape_Verdean', 'value': 'Cape_Verdean' },
    { 'label': 'Cayman_Islander', 'value': 'Cayman_Islander' },
    { 'label': 'Central_African', 'value': 'Central_African' },
    { 'label': 'Chadian', 'value': 'Chadian' },
    { 'label': 'Chilean', 'value': 'Chilean' },
    { 'label': 'Chinese', 'value': 'Chinese' },
    { 'label': 'Colombian', 'value': 'Colombian' },
    { 'label': 'Comoran', 'value': 'Comoran' },
    { 'label': 'Congolese_Congo', 'value': 'Congolese_Congo' },
    { 'label': 'Congolese_DRC', 'value': 'Congolese_DRC' },
    { 'label': 'Cook_Islander', 'value': 'Cook_Islander' },
    { 'label': 'Costa_Rican', 'value': 'Costa_Rican' },
    ...
    { 'label': 'Dominican_Dominican_Republic', 'value': 'Dominican_Dominican_Republic' },
    { 'label': 'Dutch', 'value': 'Dutch' },
    { 'label': 'East_Timorese', 'value': 'East_Timorese' },
    { 'label': 'Ecuadorean', 'value': 'Ecuadorean' },
    { 'label': 'Egyptian', 'value': 'Egyptian' },
    { 'label': 'Emirati', 'value': 'Emirati' },
    { 'label': 'English', 'value': 'English' },
    { 'label': 'Equatorial_Guinean', 'value': 'Equatorial_Guinean' },
    ...
    { 'label': 'Liechtenstein_citizen', 'value': 'Liechtenstein_citizen' },
    ...
    { 'label': 'New_Zealander', 'value': 'New_Zealander' },
    { 'label': 'Nicaraguan', 'value': 'Nicaraguan' },
    { 'label': 'Nigerian', 'value': 'Nigerian' },
    { 'label': 'Nigerien', 'value': 'Nigerien' },
    { 'label': 'Niuean', 'value': 'Niuean' },
    { 'label': 'North_Korean', 'value': 'North_Korean' },
    { 'label': 'Northern_Irish', 'value': 'Northern_Irish' },
    ...
    { 'label': 'Papua_New_Guinean', 'value': 'Papua_New_Guinean' },
    { 'label': 'Paraguayan', 'value': 'Paraguayan' },
    { 'label': 'Peruvian', 'value': 'Peruvian' },
    { 'label': 'Pitcairn_Islander', 'value': 'Pitcairn_Islander' },
    { 'label': 'Polish', 'value': 'Polish' },
    { 'label': 'Portuguese', 'value': 'Portuguese' },
    { 'label': 'Prydeinig', 'value': 'Prydeinig' },
    { 'label': 'Puerto_Rican', 'value': 'Puerto_Rican' },
    ...
    { 'label': 'Sao_Tomean', 'value': 'Sao_Tomean' },
    { 'label': 'Saudi_Arabian', 'value': 'Saudi_Arabian' },
    { 'label': 'Scottish', 'value': 'Scottish' },
    { 'label': 'Senegalese', 'value': 'Senegalese' },
    { 'label': 'Serbian', 'value': 'Serbian' },
    { 'label': 'Seychelles', 'value': 'Seychelles' },
    { 'label': 'Sierra_Leonean', 'value': 'Sierra_Leonean' },
    { 'label': 'Singaporean', 'value': 'Singaporean' },
    { 'label': 'Slovak', 'value': 'Slovak' },
    { 'label': 'Slovenian', 'value': 'Slovenian' },
    { 'label': 'Solomon_Islander', 'value': 'Solomon_Islander' },
    { 'label': 'Somali', 'value': 'Somali' },
    { 'label': 'South_African', 'value': 'South_African' },
    { 'label': 'South_Korean', 'value': 'South_Korean' },
    { 'label': 'South_Sudanese', 'value': 'South_Sudanese' },
    { 'label': 'Spanish', 'value': 'Spanish' },
    { 'label': 'Sri_Lankan', 'value': 'Sri_Lankan' },
    { 'label': 'St_Helenian', 'value': 'St_Helenian' },
    { 'label': 'St_Lucian', 'value': 'St_Lucian' },
    ...
    { 'label': 'Turks_and_Caicos_Islander', 'value': 'Turks_and_Caicos_Islander' },
    { 'label': 'Tuvaluan', 'value': 'Tuvaluan' },
    { 'label': 'Ugandan', 'value': 'Ugandan' },
    { 'label': 'Ukrainian', 'value': 'Ukrainian' },
    { 'label': 'Uruguayan', 'value': 'Uruguayan' },
    { 'label': 'Uzbek', 'value': 'Uzbek' },
    { 'label': 'Vatican_citizen', 'value': 'Vatican_citizen' },
